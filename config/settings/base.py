...
# ucl_learning_site/
APPS_DIR = ROOT_DIR / "ucl_learning_site"
env = environ.Env()
...
LOCAL_APPS = [
    "ucl_learning_site.users",
    # Your stuff: custom apps go here
    'ucl_learning_site.courses',
]
...
MIGRATION_MODULES = {"sites": "ucl_learning_site.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "ucl_learning_site.users.context_processors.allauth_settings",
            ],
        },
    }
]
...
ADMINS = [("""Hiroto Aoyama""", "hirohamu0222@gmail.com")]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "ucl_learning_site.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/forms.html
ACCOUNT_FORMS = {"signup": "ucl_learning_site.users.forms.UserSignupForm"}
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "ucl_learning_site.users.adapters.SocialAccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/forms.html
SOCIALACCOUNT_FORMS = {"signup": "ucl_learning_site.users.forms.UserSocialSignupForm"}
